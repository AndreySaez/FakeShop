package com.example.fakeshop.presentation.view.registration
...
import com.example.fakeshop.presentation.viewModel.RegisterState
import com.example.fakeshop.presentation.viewModel.RegistrationViewModel
import com.example.fakeshop.presentation.viewModel.action.RegistrationAction
...
private fun RegisterInputTextField(
    ...
    OutlinedTextField(
        ...
        onValueChange = {
            text = it
            onTextChanged(text)
            if (text.length > 24) return@OutlinedTextField
        },
        placeholder = {
