...
import com.example.fakeshop.domain.productslist.ProductListUseCase
...
sealed interface ProductAction {
    ...
    object OnFiltersClick : ProductAction
    data class ChangeFilters(val category: Category? = null, val sort: PriceSort = PriceSort.DEFAULT) : ProductAction
}
