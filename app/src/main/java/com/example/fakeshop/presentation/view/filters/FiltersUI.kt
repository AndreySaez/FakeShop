package com.example.fakeshop.presentation.view.filters
...
import com.example.fakeshop.presentation.viewModel.FiltersAction
import com.example.fakeshop.presentation.viewModel.FiltersState
import com.example.fakeshop.presentation.viewModel.FiltersViewModel
...
private fun FiltersPreview() {
    Scaffold(modifier = Modifier.fillMaxSize()) {
        FiltersScreen(
            FiltersState(
                categories = listOf(
                    Category("Хуйнина", "dsad"),
                    Category("Ебанина", "dsad"),
                    Category("Сосина", "dsad"),
                    Category("АААА", "dsad"),
                ),
